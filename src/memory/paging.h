...
void paging_init(size_t memory_size);
bool paging_addr_is_page_aligned(const void *const addr);
void *paging_align_address(const void *const addr);

int paging_map_page(struct page_directory_handle *chunk, const void *const virt, const void *const phys, const uint16_t flags);
